export const courses = {
  ...
  "ofimatica-esencial": {
    ...
    planSlug: "esencial",
    title: "Ofimática Esencial",
    shortTitle: "Ofimática Esencial",
    price: 49,
    priceInCents: 4900,
    mode: "one_time",
    active: true,
  ...
  "ofimatica-estandar": {
    ...
    courseSlug: "ofimatica",
    planSlug: "estandar",
    title: "Ofimática Estándar",
    shortTitle: "Ofimática Estándar",
    price: 119,
    priceInCents: 11900,
    mode: "one_time",
    active: true,
  ...
  "ofimatica-premium": {
    ...
    courseSlug: "ofimatica",
    planSlug: "premium",
    title: "Ofimática Premium",
    shortTitle: "Ofimática Premium",
    price: 239,
    priceInCents: 23900,
    mode: "one_time",
    active: true,
