  ...
  return (
    <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#eef9f1", padding: 24 }}>
      <section style={{ width: "100%", maxWidth: 430, background: "#fff", border: "1px solid #d7e8dd", borderRadius: 20, padding: 32 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 20 }}><Image src="/images/training/base12-training-192.png" alt="Base12 Training" width={88} height={88} style={{ borderRadius: 16 }} /><h1 style={{ margin: 0, color: "#143c2c" }}>Recuperar contraseña</h1></div>
