    ...
    <div className={styles.shell}>
      ...
      <main className={styles.main}>
        <div className={styles.topline}>
          ...
          <div className={layout.topActions}>{theme.number === 1 && <Link className={layout.accountLink} href="/?curso=auxiliar-administrativo-ja#catalogo">Suscribirse</Link>}<b>{access === "administrator" ? "Vista de administrador" : access === "public_preview" ? "Tema abierto" : "Aula Base12"}</b><Link className={layout.accountLink} href="/dashboard"><span aria-hidden="true">◯</span> Mi cuenta</Link></div>
        </div>
