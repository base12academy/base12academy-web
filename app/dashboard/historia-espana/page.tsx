  ...
  return <div className={styles.page}>
    ...
    <div className={styles.layout}>
      <aside className={styles.leftRail}>
        ...
        <div className={styles.progressLabel}><span>Progreso del curso</span><strong>58%</strong></div><div className={styles.progress} aria-label="Progreso del curso: 58%"><span style={{ width: "58%" }} /></div><div className={styles.railRule} />
...
function HistoryRightRail() { return <aside className={styles.rightRail}>
  ...
  <section className={styles.sideCard}><div className={styles.assistantHead}><Image src="/images/fernando-tutor-ia.png" alt="Fernando, tutor IA" width={1536} height={1024} /><div><h3>Fernando</h3><p>Tutor IA · Te ayuda con tu plan de estudio.</p></div><span className={styles.badge}>Beta</span></div><Link className={`${styles.secondaryLink} ${styles.assistantAction}`} href="/dashboard">Revisar mi plan de estudio →</Link></section>
