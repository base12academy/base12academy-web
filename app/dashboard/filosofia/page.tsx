...
function PhilosophyRightRail({ featured }: { featured: (typeof catalog.authors)[number] }) {
  return <aside className={styles.rightRail}>
    ...
    <section className={styles.sideCard}><div className={styles.assistantHead}><Image src="/images/fernando-tutor-ia.png" alt="Fernando, tutor IA" width={1536} height={1024} /><div><h3>Tutor IA · Fernando</h3><p>Te ayuda a planificar el estudio y mantener el ritmo.</p></div><span className={styles.badge}>Beta</span></div><div className={styles.assistantPrompts}><span>Plan de estudio</span><span>Repaso de temas</span><span>Siguientes pasos</span></div><Link className={`${styles.secondaryLink} ${styles.assistantAction}`} href="/dashboard">Abrir plan de estudio →</Link></section>
